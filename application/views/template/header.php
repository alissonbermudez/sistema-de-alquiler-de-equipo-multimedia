...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-th"></span> RESERVA DE EQUIPO MULTIMEDIA </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="<?php echo base_url().'admin/mensajes'?>">Mensajes <span class="badge"><?php echo $badges;?></span></a></li>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="<?php echo base_url()?>"><span class="glyphicon glyphicon-home"></span> Inicio <span class="sr-only">(current)</span></a></li>
                <li><a href="<?php echo base_url().'admin/reservas'?>"><span class="glyphicon glyphicon-th-list"></span> Reservas</a></li>
                <li><a href="<?php echo base_url().'admin/equipo'?>"><span class="glyphicon glyphicon-blackboard"></span>Equipo</a></li>
                <li><a href="<?php echo base_url().'admin/reporte'?>"><span class="glyphicon glyphicon-file"></span>Reportes</a></li>
                <li><a href="<?php echo base_url().'admin/usuarios'?>"><span class="glyphicon glyphicon-user"></span>Usuarios</a></li>
