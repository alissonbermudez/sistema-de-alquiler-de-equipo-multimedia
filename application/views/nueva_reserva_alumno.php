        ...
        <?php foreach($equipo as $item): ?>
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-primary btn-xs" href="<?php echo base_url().'alumno/guardar_reserva/'.$carnet.'/'.$item->idequipo.'/'.$horario.'/'.$fecha ?>" >Reservar</a>
...
<br> <B>  NUEVA RESERVA DE EQUIPO:</B> NOS MUESTA LA PANTALLA PRINCIPAL DONDE PODEMOS REALIZAR LAS RESERVAS DE  LOS EQUIPOS. <br/>
