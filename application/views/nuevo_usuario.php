...
<form class="form-horizontal" method="post" action="<?php echo base_url().'admin/guardar_usuario'?>">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        <input id="nombre" name="nombre" placeholder="Nombre completo" class="form-control input-md" type="text">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        <input id="usuario" name="usuario" placeholder="" class="form-control input-md" type="text">
      ...
      <div class="form-group" id="parentpass">
        ...
        <div class="col-md-4">
          <input id="password" name="password" pattern="[a-zA-Z0-9_]{5,}$" oninvalid="setCustomValidity('Debe tener minimo 5 caracteres')" title="El password debe tener 5 caracteres minimos"   placeholder="" class="form-control input-md" required="" type="password">
      ...
      <div class="form-group " id="confir">
        ...
        <div class="col-md-4">
          <input id="confirmar" name="confirmar" pattern="[a-zA-Z0-9_]{5,}$" placeholder="" class="form-control input-md " type="password">
...
password.onchange = validatelenght;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <br> <B> CREAR NUEVO USUARIO :</B> NOS MUESTA LA PANTALLA PRINCIPAL DONDE PODEMOS CREAR  LOS NUEVOS USUARIOS DEL SISTEMA. <br/>
