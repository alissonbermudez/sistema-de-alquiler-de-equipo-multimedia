...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">RESERVA DE EQUIPO MULTIMEDIA </a>
        </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h2 class="sub-header">Reservas del dia <?php echo date('d/m/y')?></h2>
            <div class="table-responsive">
                <table class="table table-striped " id="dia">
                    <thead>
                    <tr>
                        <th>#</th>
                        <th>Header</th>
